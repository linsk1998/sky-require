...
import {getScript,getCurrentScript,getCurrentPath,forOwn} from "sky-core";
...
全局变量中的require
*/
this.require=function(deps,callback,onerror){
	var from;
...
function urlToModule(name,url,from){
	...
	url=null;
	return getJsModule(name,path,from);
}
...
/*
	...
	*/
this.define=function(arg1,arg2,arg3){
